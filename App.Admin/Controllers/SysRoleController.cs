...
namespace App.Admin.Controllers
{
    public class SysRoleController : BaseController
    {
        ...
        public SysRoleController(ISysRoleBLL SysRoleBLL, ISysLogBLL SysLogBLL)
        {
            this.m_BLL = SysRoleBLL;
            this.m_Log = SysLogBLL;
        }
        ...
        public JsonResult Create(SysRoleModel model)
        {
            ...
            if (model != null && ModelState.IsValid)
            {
                ...
                {
                    m_Log.WriteServiceLog(GetUserId(), "Id" + model.Id + ",Name" + model.Name, "成功", "创建", "SysRole");
                    return Json(JsonHandler.CreateMessage(1, Suggestion.InsertSucceed));
                }
                else
                {
                    string ErrorCol = errors.Error;
                    m_Log.WriteServiceLog(GetUserId(), "Id" + model.Id + ",Name" + model.Name + "," + ErrorCol, "失败", "创建", "SysRole");
        ...
        public JsonResult Edit(SysRoleModel model)
        {
            if (model != null && ModelState.IsValid)
            {
                ...
                {
                    m_Log.WriteServiceLog(GetUserId(), "Id" + model.Id + ",Name" + model.Name, "成功", "修改", "SysRole");
                    return Json(JsonHandler.CreateMessage(1, Suggestion.EditSucceed));
                }
                else
                {
                    string ErrorCol = errors.Error;
                    m_Log.WriteServiceLog(GetUserId(), "Id" + model.Id + ",Name" + model.Name + "," + ErrorCol, "失败", "修改", "SysRole");
        ...
        public JsonResult Delete(string id)
        {
            if (!string.IsNullOrWhiteSpace(id))
            {
                ...
                {
                    m_Log.WriteServiceLog(GetUserId(), "Id:" + id, "成功", "删除", "SysRole");
                    return Json(JsonHandler.CreateMessage(1, Suggestion.DeleteSucceed));
                }
                else
                {
                    string ErrorCol = errors.Error;
                    m_Log.WriteServiceLog(GetUserId(), "Id" + id + "," + ErrorCol, "失败", "删除", "SysRole");
        ...
        public JsonResult UpdateUserRoleByRoleId(string roleId, string userIds)
        {
            ...
            {
                m_Log.WriteServiceLog(GetUserId(), "Ids:" + arr, "成功", "分配用户", "角色设置");
                return Json(JsonHandler.CreateMessage(1, Suggestion.SetSucceed), JsonRequestBehavior.AllowGet);
            }
            else
            {
                string ErrorCol = errors.Error;
                m_Log.WriteServiceLog(GetUserId(), "Ids:" + arr, "失败", "分配用户", "角色设置");
