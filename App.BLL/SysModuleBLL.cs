...
namespace App.BLL
{
    ...
    {
        ISysModuleRepository m_Rep;
        public SysModuleBLL(ISysModuleRepository sysModuleRepository)
        {
            this.m_Rep = sysModuleRepository;
        }

        public List<SysModuleModel> GetList(string parentId)
        {
            IQueryable<SysModule> queryData = null;
            queryData = m_Rep.GetList(dbContainer).Where(a => a.ParentId == parentId).OrderBy(a => a.Sort);
        ...
        public List<SysModule> GetModuleBySystem(string parentId)
        {
            ...
            return m_Rep.GetModuleBySystem(dbContainer, parentId).ToList();
        }
